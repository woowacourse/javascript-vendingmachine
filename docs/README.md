...
- 금액 투입
  ...
  - [ ] 상품 구매 탭이 클릭된다.
  - [ ] 상품 구매 메뉴에 해당하는 화면을 렌더링 한다.
  - [ ] 상품 구매폼에 금액이 입력된다.
    - [ ] [예외 - 금액] 가격이 공백인 경우
    - [ ] [예외 - 금액] 가격이 정수가 아닌 경우
    - [ ] [예외 - 금액] 가격이 100원 미만인 경우
    - [ ] [예외 - 금액] 가격이 10,000원을 초과하는 경우
    - [ ] [예외 - 금액] 가격이 10원으로 나누어떨어지지 않는 경우
  - [ ] 투입 버튼이 클릭된다.
  - [ ] 투입한 금액을 이전 투입 금액에 누적하여 렌더링한다.
    - 최초 충전 금액은 0원이다.
    - 금액은 누적으로 투입될 수 있다.
...
- 상품 구매
  ...
  - [ ] 상품 구매 버튼이 클릭된다.
    - [ ] [예외 - 구매] 투입한 금액보다 상품의 가격이 비싼 경우
  - [ ] 구매 후, 수량이 0개가 되었을 때, 해당 상품이 삭제된다.
  - [ ] 구매 후, 투입한 금액에서 상품의 가격만큼을 빼고 렌더링한다.
