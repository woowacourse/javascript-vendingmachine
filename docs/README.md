...
- 금액 투입
  ...
  - [x] 투입 버튼이 클릭된다. (UI)
  - [x] snackbar로 금액 투입 성공 여부를 보여준다. (UI)
  - [x] 투입한 금액을 충전한다. (도메인)
...
- 상품 구매
  ...
  - [x] 구매 버튼이 클릭된다. (UI)
    - [x] [예외] 투입한 금액이 부족한 경우
    - [x] [예외] 수량이 1개 미만인 경우
  - [x] snackbar로 상품 구매 성공 여부를 보여준다. (UI)
...
- 잔돈 반환
  ...
  - [x] 반환 버튼이 클릭된다. (UI)
    - [x] [예외] 투입한 금액이 0원인 경우
  - [x] snackbar로 잔돈 반환 성공 여부를 보여준다. (UI)
  - [x] 투입한 금액을 줄인다. (도메인)
  - [x] 투입한 금액을 리렌더링 한다. (UI)
...
- 비로그인 사용자
  ...
  - 회원가입
    ...
    - [x] 회원가입 버튼이 클릭된다. (UI)
    - [x] 회원가입 폼을 렌더링 한다. (UI)
    - [x] 이메일, 이름, 비밀번호, 비밀번호 확인이 입력된다. (UI)
      - [x] [예외 - 이메일] 이메일이 공백인 경우
      - [x] [예외 - 이메일] 이메일이 공백으로만 이루어진 경우
      - [x] [예외 - 이메일] 이메일이 이메일 형식이 아닌 경우
      - [x] [예외 - 이메일] 이메일이 이미 존재하는 경우
      - [x] [예외 - 이름] 이름이 공백인 경우
      - [x] [예외 - 이름] 이름이 공백으로만 이루어진 경우
      - [x] [예외 - 이름] 이름이 2글자 미만이거나 6글자를 초과하는 경우
      - [x] [예외 - 비밀번호 확인] 비밀번호 확인이 비밀번호와 일치하지 않는 경우
    - [x] 확인 버튼이 클릭된다. (UI)
  ...
  - 로그인
    ...
    - [x] 이메일, 비밀번호가 입력된다. (UI)
      ...
      - [x] [예외 - 이메일] 이메일이 공백으로만 이루어진 경우
      - [x] [예외 - 이메일] 이메일이 이메일 형식이 아닌 경우
      - [x] [예외 - 이메일] 이메일이 존재하지 않는 경우
      - [x] [예외 - 비밀번호] 비밀번호가 틀린 경우
    - [x] 확인 버튼이 클릭된다. (UI)
