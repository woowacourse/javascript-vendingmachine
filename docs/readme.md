...
- [ ] 사용자는 구입 금액을 입력하여 누적으로 투입할 수 있다.
...
- 사용자의 행동 성공/실패 결과를 snackbar로 보여준다.

#### 관리자 회원 기능

- [ ] 관리자가 되고자하는 유저는 회원가입을 할 수 있다.
  - [ ] name은 2~6글자까지 가능하다.
  - [ ] password는 규칙을 정한다.
- [ ] 관리자는 로그인을 할 수 있다.
...
- [ ] 로그인한 유저의 썸네일을 클릭하면 회원 정보 수정, 로그아웃 메뉴가 있다.
- [ ] 관리자는 로그아웃 할 수 있다.
  - [ ] 로그아웃 후에는 로그인 버튼으로 변경된다.
