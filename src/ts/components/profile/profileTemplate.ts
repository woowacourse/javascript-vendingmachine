...
const profileTemplate = () => {
  ...
  return `
      ...
      <form class="profile-form">
        <label>이메일</label>
        <input class="profile-form__email-input user-input" name="email" type="email" placeholder=${userInfo.email} disabled />
        <label>이름</label>
        <input class="profile-form__name-input user-input" name="name" type="text" placeholder="이름을 입력해주세요" value=${userInfo.name} />
        <label>비밀번호</label>
