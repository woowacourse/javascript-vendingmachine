...
/* harmony import */ var _js_util_checkLogin__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./js/util/checkLogin */ "./src/js/util/checkLogin.js");
/* harmony import */ var _js_util_event__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./js/util/event */ "./src/js/util/event.js");
/* harmony import */ var _js_util_localStorage__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./js/util/localStorage */ "./src/js/util/localStorage.js");
/* harmony import */ var _js_util_snackbar__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./js/util/snackbar */ "./src/js/util/snackbar.js");
...
var UserEditForm = /*#__PURE__*/function () {
  function UserEditForm() {
    var _this = this;

    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, UserEditForm);
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__["default"])(this, "onSubmit", /*#__PURE__*/function () {
      var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().mark(function _callee(e) {
        var name, password, confirmPassword, response, body, user;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                e.preventDefault();
                name = _this.$editUserName.value;
                password = _this.$editUserPassword.value;
                confirmPassword = _this.$editUserPasswordConfirm.value;
              ...
              case 6:
                _context.next = 8;
                return fetch("https://json-auth-server.herokuapp.com/users/".concat(_this.user.id), {
                  method: "PATCH",
              ...
              case 11:
                ...
                (0,_js_util_snackbar__WEBPACK_IMPORTED_MODULE_10__["default"])(_this.$snackbar, body);
                return _context.abrupt("return");
              ...
              case 15:
                ...
                (0,_js_util_localStorage__WEBPACK_IMPORTED_MODULE_9__.setLocalStorage)("user-info", user);
                location.href = "./";
    ...
    this.$editUserPasswordConfirm = document.querySelector("#edit-user-password-confirm");
    this.$snackbar = document.querySelector("#snackbar");
    (0,_js_util_event__WEBPACK_IMPORTED_MODULE_8__.addEvent)(this.$editUserForm, "submit", this.onSubmit);
    this.user = JSON.parse(localStorage.getItem("user-info"));
    this.checkLoginStatus();
    this.setEditUserInputValue();
  }

  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(UserEditForm, [{
    key: "checkLoginStatus",
    value: function checkLoginStatus() {
      if (!(0,_js_util_checkLogin__WEBPACK_IMPORTED_MODULE_7__["default"])()) {
        (0,_js_util_snackbar__WEBPACK_IMPORTED_MODULE_10__["default"])(this.$snackbar, _js_constant__WEBPACK_IMPORTED_MODULE_6__.ERROR_MESSAGE.MUST_LOGIN, function () {
          location.href = "./";
        });
      }
    }
  }, {
    key: "setEditUserInputValue",
    value: function setEditUserInputValue() {
