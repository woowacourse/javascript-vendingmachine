...
var VendingMachine = /** @class */ (function () {
    function VendingMachine() {
        ...
        this.getProductsFromStorage = function (key) {
            var productsFromStorage = JSON.parse(localStorage.getItem(key));
            return productsFromStorage === null || productsFromStorage === void 0 ? void 0 : productsFromStorage.map(function (_a) {
                var name = _a.name, price = _a.price, quantity = _a.quantity;
                return new _Product__WEBPACK_IMPORTED_MODULE_0__["default"]({ name: name, price: price, quantity: quantity });
            });
        };
        this.getMoneyFromStorage = function (key) {
            var moneyFromStorage = JSON.parse(localStorage.getItem(key));
            return moneyFromStorage === null || moneyFromStorage === void 0 ? void 0 : moneyFromStorage.map(function (_a) {
                var value = _a.value, count = _a.count;
                return new _Money__WEBPACK_IMPORTED_MODULE_1__["default"](value, count);
            });
        };
        ...
        this.addProduct = function (product) {
            var productToAdd = new _Product__WEBPACK_IMPORTED_MODULE_0__["default"](product);
        ...
        this.money = this.getMoneyFromStorage(_constants__WEBPACK_IMPORTED_MODULE_4__.STORAGE_ID.MONEY) || [
            new _Money__WEBPACK_IMPORTED_MODULE_1__["default"](_constants__WEBPACK_IMPORTED_MODULE_4__.COIN.VALUE_500, 0),
            new _Money__WEBPACK_IMPORTED_MODULE_1__["default"](_constants__WEBPACK_IMPORTED_MODULE_4__.COIN.VALUE_100, 0),
            new _Money__WEBPACK_IMPORTED_MODULE_1__["default"](_constants__WEBPACK_IMPORTED_MODULE_4__.COIN.VALUE_50, 0),
            new _Money__WEBPACK_IMPORTED_MODULE_1__["default"](_constants__WEBPACK_IMPORTED_MODULE_4__.COIN.VALUE_10, 0),
        ];
    }
...
var ProductManageView = /** @class */ (function () {
    function ProductManageView(vendingMachine) {
        ...
        this.handleEdit = function (target) {
            var _a = _this.vendingMachine.getProduct(target.dataset.name), name = _a.name, price = _a.price, quantity = _a.quantity;
        ...
        this.renderEditedProduct = function (productToEdit, targetEdit) {
            var editedProduct = _this.vendingMachine.getProduct(productToEdit.name);
            var newTr = document.createElement('tr');
            newTr.className = 'product-row';
        ...
        this.$productNameInput = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.$)('#product-name', this.$productManageForm);
        this.$productPriceInput = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.$)('#product-price', this.$productManageForm);
        this.$productQuantityInput = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.$)('#product-quantity', this.$productManageForm);
...
var RechargeView = /** @class */ (function () {
    function RechargeView(vendingMachine) {
        ...
        this.renderCoinTable = function () {
            _this.$coin500.textContent = String(_this.vendingMachine.getCoin(500).count);
            _this.$coin100.textContent = String(_this.vendingMachine.getCoin(100).count);
            _this.$coin50.textContent = String(_this.vendingMachine.getCoin(50).count);
            _this.$coin10.textContent = String(_this.vendingMachine.getCoin(10).count);
        };
        this.$rechargeForm = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.$)('.recharge-form');
        this.$currentHoldingMoney = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.$)('#current-holding-money', this.$rechargeForm);
...
var View = /** @class */ (function () {
    function View(vendingMachine) {
        ...
        this.renderUpdatedView = function (id) {
            var _a;
            var containerBranch = (_a = {},
                _a[_constants__WEBPACK_IMPORTED_MODULE_1__.PATH_ID.PRODUCT_MANAGE] = function () {
                    _this.productManageView.renderProductManage();
                },
                _a[_constants__WEBPACK_IMPORTED_MODULE_1__.PATH_ID.RECHARGE] = function () {
                    _this.rechargeView.renderRecharge();
                },
                _a[_constants__WEBPACK_IMPORTED_MODULE_1__.PATH_ID.PURCHASE_PRODUCT] = function () {
        ...
        this.tabRouter = function (tabKey, isPopState) {
            var _a;
            ...
            var routes = (_a = {},
                ...
                _a[_constants__WEBPACK_IMPORTED_MODULE_1__.PATH_ID.RECHARGE] = function () {
                    _this.renderTabs(_constants__WEBPACK_IMPORTED_MODULE_1__.PATH_ID.RECHARGE);
                },
                _a[_constants__WEBPACK_IMPORTED_MODULE_1__.PATH_ID.PURCHASE_PRODUCT] = function () {
                    _this.renderTabs(_constants__WEBPACK_IMPORTED_MODULE_1__.PATH_ID.PURCHASE_PRODUCT);
                },
                _a);
            routes[tabKey]();
        };
        this.isSamePage = function (tabKey) { return tabKey === window.location.pathname + window.location.hash; };
        ...
        window.addEventListener('popstate', function (event) {
            _this.tabRouter(event.state.url, _constants__WEBPACK_IMPORTED_MODULE_1__.FLAG.POP_STATE);
        });
