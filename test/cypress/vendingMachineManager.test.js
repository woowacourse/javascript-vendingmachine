...
describe('관리자의 상품 관리, 자판기 잔돈 충전 기능이 요구사항과 일치해야 한다.', () => {
  ...
  context('상품 관리에 대한 테스트', () => {
    ...
    it(`추가할 상품 이름은 최소 1자, 최대 10자까지 가능하다. 해당 조건 범위를 벗어나는 경우 안내 snack bar를 확인할 수 있다.`, () => {
      goProductManagementPage();
    ...
    it(`추가할 상품의 가격은 최소 100원, 최대 10,000원까지 가능하다. 해당 조건 범위를 벗어나는 경우 안내 snack bar를 확인할 수 있다.`, () => {
      goProductManagementPage();
    ...
    it(`추가할 상품의 가격은 10원 단위로 입력 가능하다. 해당 조건을 벗어나는 경우 안내 snack bar를 확인할 수 있다.`, () => {
      goProductManagementPage();
    ...
    it(`추가할 상품의 수량은 최소 1개, 최대 20개까지 가능하다. 해당 조건 범위를 벗어나는 경우 안내 snack bar를 확인할 수 있다.`, () => {
      goProductManagementPage();
  ...
  context('잔돈 충전에 대한 테스트', () => {
    ...
    it(`자판기 잔돈 충전금은 10원 단위로 입력 가능하다. 해당 조건을 벗어나는 경우 안내 snack bar를 확인할 수 있다.`, () => {
      const charge = 1055;
    ...
    it(`자판기 잔돈은 누적 100,000원까지 충전 가능하다. 해당 조건을 벗어나는 경우 안내 snack bar를 확인할 수 있다.`, () => {
