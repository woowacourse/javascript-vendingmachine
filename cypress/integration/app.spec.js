...
//     cy.get(".product-control-input").eq(0).type("사이다");
//     cy.get(".product-control-input").eq(1).type(2000);
//     cy.get(".product-control-input").eq(2).type(20);
...
//     cy.get(".product-control-input").eq(0).type("사이다");
//     cy.get(".product-control-input").eq(1).type(1000);
//     cy.get(".product-control-input").eq(2).type(10);
//     cy.get("#product-add-button").click();
// 
...
//     cy.get(".product-control-input").eq(0).type("사이다를마시다가용트름");
//     cy.get(".product-control-input").eq(1).type(1000);
//     cy.get(".product-control-input").eq(2).type(10);
//     cy.get("#product-add-button").click();
// 
...
//     cy.get(".product-control-input").eq(0).type("콜라");
//     cy.get(".product-control-input").eq(1).type(10001);
//     cy.get(".product-control-input").eq(2).type(10);
//     cy.get("#product-add-button").click();
// 
//     cy.on("window:alert", (alertText) => {
...
//     cy.get(".product-control-input").eq(0).type("콜라");
//     cy.get(".product-control-input").eq(1).type(1001);
//     cy.get(".product-control-input").eq(2).type(10);
//     cy.get("#product-add-button").click();
// 
//     cy.on("window:alert", (alertText) => {
...
//     cy.get(".product-control-input").eq(0).type("콜라");
//     cy.get(".product-control-input").eq(1).type(1000);
//     cy.get(".product-control-input").eq(2).type(11);
//     cy.get("#product-add-button").click();
// 
//     cy.on("window:alert", (alertText) => {
...
describe("잔돈 관리 탭 테스트", () => {
  ...
  it(`최소 ${CHARGE.MIN_PRICE}원, 최대 ${CHARGE.MAX_PRICE}원까지 충전할 수 있다.`, () => {
    cy.get(".charge-control-input").type(100001);
    cy.get("#charge-add-button").click();
    ...
    cy.get(".charge-control-input").type(1001);
    cy.get("#charge-add-button").click();
